...
deploy_robots_final_0 = np.random.randint(0, max_robots, size=(num_nodes, num_species))
deploy_robots_final_1 = np.random.randint(0, max_robots, size=(num_nodes, num_species))
deploy_robots_final_2 = np.random.randint(0, max_robots, size=(num_nodes, num_species))
