...
print 'sum_species_t', sum_species_t
...
deploy_robots_final_0 = np.random.randint(0, 100, size=(num_nodes, num_species)).astype(float)
deploy_robots_final_1 = np.random.randint(0, 100, size=(num_nodes, num_species)).astype(float)
deploy_robots_final_2 = np.random.randint(0, 100, size=(num_nodes, num_species)).astype(float)
